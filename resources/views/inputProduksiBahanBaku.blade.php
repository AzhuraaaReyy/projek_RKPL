      ...
      ${data.status ?? '-'}
        ...
        function editData(id) {
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="edit_jumlah" name="stok" value="${data.stok}" min="0" step="0.01">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="edit_harga_per_unit" name="harga" value="${data.harga}" min="0" step="1">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            `;
                    ...
                    document.getElementById('editBahanForm').action = `/api/bahan-baku/${id}`;
        ...
        $('#editBahanForm').on('submit', function(e) {
            ...
            axios.put(`/api/bahan-baku/${id}`, data)
                .then(response => {
        ...
        function updateTableRow(id, data) {
            ...
            <td class="text-center">${new Date(data.tanggal_kedaluwarsa).toLocaleDateString('id-ID')}</td>
            <td class="text-right">Rp ${data.harga.toLocaleString('id-ID')}</td>
