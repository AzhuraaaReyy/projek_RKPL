    ...
    <script>
        $(document).ready(function() {
            ...
            const table = $('#productionHistoryTable').DataTable({
                ...
                order: [[4, 'desc']], // Order by production date descending
                columnDefs: [
                    { targets: [10], orderable: false }, // Disable sorting for action column
                    { targets: [6], className: 'text-center' }, // Center align ingredients
                    { targets: [5], className: 'text-right' } // Right align cost
                ],
