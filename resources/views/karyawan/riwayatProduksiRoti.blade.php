                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="info-box bg-primary">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">{{ $totals }} <small>Records</small></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="info-box bg-warning">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">{{$countPlanning}} <small>Items</small></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="info-box bg-danger">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">{{$countCancelled}} <small>Items</small></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="main-card animate__animated animate__fadeInUp animate__delay-1s">
                        ...
                        <div class="filter-section">
                            <div class="filter-card">
                                <form method="GET" action="{{ route('filterBykaryawanroduksi') }}" onsubmit="return validateFilterForm()">
                                    <div class="row">
                                        <!-- Tanggal Mulai -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 d-flex align-items-end">
                                            ...
                                            <a href="/karyawanriwayatProduksiRoti" class="btn btn-reset">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <span class="status-badge status-planning">
                                                    <i class="fas fa-clock mr-1"></i>in_progress
                                                </span>
