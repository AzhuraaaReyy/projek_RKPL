                ...
                <div class="row animate__animated animate__fadeInUp">
                    <div class="col-lg-6 col-md-12">
                        <div class="action-card">
                            <a href="{{route('karyawan.formproduk')}}" class="action-btn btn-add-product">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="action-card">
                            <a href="/karyawan-formproduksi" class="action-btn btn-add-production">
                                <div class="action-icon">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form action="{{ route('karyawan.productions.update', $product->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('PATCH')
