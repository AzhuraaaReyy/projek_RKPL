                    ...
                    <div class="row animate__animated animate__fadeInUp animate__delay-1s">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <form action="{{ route('customers.karyawanfilter') }}" method="GET">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <a href="{{ route('karyawan.customers') }}" class="btn btn-secondary ml-2">Reset</a>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form method="POST" action="{{ route('customers.karyawandelete', $customer->id) }}" style="display: inline-block;">
                                                            @csrf
                                                            @method('DELETE')
